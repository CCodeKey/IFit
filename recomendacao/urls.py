...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='recomendacao/password_reset_form.html', email_template_name='recomendacao/password_reset_email.html'), name='password_reset'),
